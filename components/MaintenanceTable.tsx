...
import { ChevronDown, Calendar, Wifi, Router, Thermometer, MoreVertical } from 'lucide-react';
...
function getStatusBadge(status: MaintenanceStatus) {
  switch (status) {
    ...
    case 'healthy':
      return <Badge className="bg-emerald-500 text-white text-xs">Healthy</Badge>;
  }
}
      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          ...
          <div className="relative">
            ...
            {showStatusDropdown && (
              <div className="absolute top-full left-0 mt-1 bg-popover border border-border rounded-md shadow-lg z-10 min-w-35">
                {(['all', 'critical', 'warning', 'scheduled', 'healthy'] as FilterStatus[]).map(
                  status => (
                    <button
                      key={status}
          ...
          <div className="relative">
            ...
            {showLocationDropdown && (
              <div className="absolute top-full left-0 mt-1 bg-popover border border-border rounded-md shadow-lg z-10 min-w-40 max-h-50 overflow-auto">
                <button
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border text-muted-foreground">
                ...
                <th className="text-left py-3 px-2 font-medium">DEVICE DETAILS</th>
                <th className="text-left py-3 px-2 font-medium">LOCATION</th>
                <th className="text-left py-3 px-2 font-medium">MAINTENANCE TASK</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-2">
                        <span
                          className={
                            isTodayDue ? 'text-red-500 font-medium' : 'text-muted-foreground'
                          }
                        >
