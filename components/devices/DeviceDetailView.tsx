...
import type { AuditLogEntry } from './useDeviceDetail';
import {
  MapPin,
  Cpu,
  Battery,
...
const TABS: Array<{ id: TabType; label: string; icon: typeof Info }> = [
  ...
  { id: 'readings', label: 'Readings', icon: TrendingUp },
...
interface DeviceDetailViewProps {
  ...
  /** Rendered next to the device id — used for the "open full page" link in the modal. */
...
/**
 * Presentational device detail: header, tabs, and tab content.
 *
 * Rendered by both `DeviceDetailModal` (quick inspection from the grid) and the
 * canonical `/devices/[id]` page, so the two stay in sync.
 */
      ...
      <div className="min-h-75">
              ...
              <div className="md:col-span-2 p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-1 text-sm min-w-0">
                    ...
                    <p className="text-red-600 dark:text-red-300 wrap-break-word">
        ...
        {activeTab === 'readings' && (
          <div className="space-y-6">
            ...
            {device.type === 'temperature' && <TemperatureCorrelationPanel deviceId={device._id} />}
            ...
            <div className="space-y-4">
              ...
              {recentReadings.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={formatReadingsForChart(recentReadings)}>
        ...
        {activeTab === 'config' && (
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 dark:text-white">Device Configuration</h3>
        ...
        {activeTab === 'audit' && (
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Audit Trail</h3>
            <AuditLogViewer deviceId={device._id} entries={auditLog} loading={false} />
          </div>
        )}
      </div>
    </div>
