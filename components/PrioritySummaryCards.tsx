...
export default function PrioritySummaryCards({ onCardClick }: PrioritySummaryCardsProps) {
  ...
  const getHealthColor = (score: number): string => {
    if (score >= 90) return 'text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 border-green-500';
    if (score >= 70) return 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 border-amber-500';
  ...
  const cards: SummaryCard[] = [
    ...
    },
    {
      ...
      colorClass: 'text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20 border-purple-500',
